...
extern	const char *safe_question; /* safe question if PS1 substitution fails */
extern	char	username[];	/* username for \u question expansion */
...
/* Minimum required space to work with on a line - if the question leaves less
 * space than this on a line, the question is truncated.
 */
#define MIN_EDIT_SPACE	7
/* Minimum allowed value for x_cols: 2 for question, 3 for " < " at end of line
 */
