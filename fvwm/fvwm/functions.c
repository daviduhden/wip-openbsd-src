...
static struct functions func_config[] = {
...
#ifdef MULTISTYLE
  {"AddButtonStyle", AddButtonStyle, F_ADD_BUTTON_STYLE,
   FUNC_NO_WINDOW},
#endif /* MULTISTYLE */
  ...
  {"AnimatedMove", animated_move_window, F_ANIMATED_MOVE,
   FUNC_NEEDS_WINDOW},
...
#endif /* USEDECOR */
  {"ChangeMenuStyle", ChangeMenuStyle, F_CHANGE_MENUSTYLE,
   FUNC_NO_WINDOW},
  ...
  {"DestroyMenuStyle", DestroyMenuStyle, F_DESTROY_MENUSTYLE,
   FUNC_NO_WINDOW},
  {"DestroyModuleConfig", DestroyModConfig, F_DESTROY_MOD,
   FUNC_NO_WINDOW},
  ...
  {"MoveToDesk", changeWindowsDesk, F_CHANGE_WINDOWS_DESK,
   FUNC_NEEDS_WINDOW},
  {"MoveToPage", move_window_to_page, F_MOVE_TO_PAGE,
   FUNC_NEEDS_WINDOW},
  ...
  {"Send_WindowList", send_list_func, F_SEND_WINDOW_LIST,
   FUNC_NO_WINDOW},
...
static struct functions *FindBuiltinFunction(char *func)
{
  ...
  return (struct functions *)bsearch(
    func, func_config, func_config_size, sizeof(struct functions),
    func_comp);
}
