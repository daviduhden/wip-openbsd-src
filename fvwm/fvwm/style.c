  ...
  while((*restofline != 0)&&(*restofline != '\n'))
  {
    ...
    switch (tolower(restofline[0]))
    {
      case 'a':
        ...
        else if (ITIS("ACCEPTFOCUS"))
        {
          SKIP("ACCEPTFOCUS");
          tname.has_never_focus = 1;
          tname.never_focus = 0;
        }
        break;
      case 'b':
        if(ITIS("BACKCOLOR"))
        {
          ...
          if(len > 0)
          {
            ...
            memcpy(tname.BackColor, restofline, (size_t)len);
      ...
      case 'c':
        if(ITIS("COLOR"))
        {
          ...
          if(len > 0)
          {
            ...
            memcpy(tname.ForeColor, restofline, (size_t)len);
      ...
      case 'i':
        ...
        else if(ITIS("IconBox"))
        {
          ...
          if (num == 4) {               /* if 4 numbers */
            ...
            if(len > 0 && len < 24) {   /* if word found, not too long */
              memcpy(geom_string, restofline, (size_t)len); /* copy and null term */
        ...
        else if(ITIS("ICON"))
        {
          ...
          if(len > 0)
          {
            ...
            memcpy(tname.value, restofline, (size_t)len);
            tname.value[len] = 0;
	...
	else if (ITIS("MINIICON"))
	{
          ...
          if(len > 0)
          {
            ...
            memcpy(tname.mini_value, restofline, (size_t)len);
      ...
      case 'u':
        ...
        if(ITIS("UseDecor"))
        {
          ...
          if (len > 0)
          {
            ...
            memcpy(tname.Decor, restofline, (size_t)len);
            tname.Decor[len] = 0;
          }
          restofline = tmp;
        }
