...
/**/
  ...
  /* Apply NeverFocus style if specified */
  if (styles.has_never_focus)
  {
    tmp_win->tmpflags.NeverFocus = (styles.never_focus ? 1 : 0);
  }
...
/*  RBW - 11/02/1998  */
  ...
  */
  ...
  /* EWMH: update client list and desktop count/names/workarea if needed */
  EWMH_UpdateClientList();
  EWMH_UpdateClientListStacking();
  EWMH_RecalcDesktops();
  /* EWMH per-window props: allowed actions and window type */
