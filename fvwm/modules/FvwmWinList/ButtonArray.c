...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
Button *
ButtonNew(char *title, FvwmPicture *p, int up)
{
	Button *new;
...
******************************************************************************/
void
UpdateArray(ButtonArray *array, int x, int y, int w, int h)
{
	Button *temp;
...
******************************************************************************/
int
AddButton(ButtonArray *array, char *title, FvwmPicture *p, int up)
{
	Button *new;
...
******************************************************************************/
int
UpdateButton(ButtonArray *array, int butnum, char *title, int up)
{
	Button *temp;
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
int
UpdateButtonPicture(ButtonArray *array, int butnum, FvwmPicture *p)
{
	Button *temp;
	temp = find_n(array, butnum);
	if (temp == NULL)
...
******************************************************************************/
int
UpdateButtonSet(ButtonArray *array, int butnum, int set)
{
	Button *btn;
...
******************************************************************************/
int
UpdateButtonDesk(ButtonArray *array, int butnum, long desk)
{
	Button *btn;
...
DoButton(Button *button, int x, int y, int w, int h)
{
      ...
      (w + button->p.width + w3p + 3 > MIN_BUTTON_SIZE)*/)
  {
	...
	XDrawString(dpy, win, graph[set], x + newx, y + 3 + ButtonFont->ascent,
	    string, strlen(string));
	button->needsupdate = 0;

	/* Draw relief last, don't forget that XDrawLine doesn't do the last
	 * pixel */
...
******************************************************************************/
void
SwitchButton(ButtonArray *array, int butnum)
{
	Button *btn;
